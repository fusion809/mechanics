...
\end{align*}
%\begin{align*}
%	\mathcal{L} &= \dfrac{m_1+m_2}{2}\left(\dot{z}_1^2+(l_1+z_1)^2\dot{\theta}_1^2-2g(l_1+z_1)\sin{\theta_1}\right) + \dfrac{m_2}{2}\left[\dot{z}_2^2+ (l_2+z_2)^2\dot{\theta}_2^2 + 2\dot{z}_1\dot{z}_2\cos{(\theta_2-\theta_1)} + 2\dot{\theta}_1\dot{z}_2(l_1+z_1)\sin{(\theta_2-\theta_1)} - 2\dot{z}_1(l_2+z_2)\dot{\theta}_2\sin{(\theta_2-\theta_1)}\right.\\
%	&\left.+2(l_1+z_1)(l_2+z_2)\dot{\theta}_1\dot{\theta}_2\cos{(\theta_2-\theta_1)}-2g(l_2+z_2)\sin{\theta_2}\right] - \dfrac{k_1 z_1^2}{2} - \dfrac{k_2z_2^2}{2}
%\end{align*}
\end{landscape}
\end{document}